...
class _ReceiptsPageState extends State<ReceiptsPage> {
  ...
  // Modified WhatsApp functionality to navigate to WhatsApp chat
  ...
  // Modified _editReceipt method to navigate to NewReceiptPage
  void _editReceipt(Receipts receipt) async {
    // Prepare comprehensive receipt data for editing - matching NewReceiptPage editData parameter
    final editData = {
      'rcpId': receipt.rcpId,
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDialogRow('Customer Name:', receipt.name),
              const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  if (receiptView == "yes")
                                    _buildActionButton(
                                      icon: Icons.visibility, // Changed from Icons.print to Icons.visibility (eye icon)
                                      label: 'View',
                                      backgroundColor: const Color.fromARGB(255, 5, 38, 76),
                                  ...
                                  if (receiptWhatsapp == "yes")
                                    _buildActionButton(
                                      ...
                                      onPressed: () => openWhatsAppChat(context, receipt), // Changed to openWhatsAppChat
                                    ),
                                  if (receiptWhatsapp == "yes")
                                    const SizedBox(width: 6),
      ...
      bottomNavigationBar: const BottomNavigationButton(
        selectedIndex: 0, // Assuming receipts is index 0 based on typical navigation
      ),
    );
  }
