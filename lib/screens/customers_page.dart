...
import 'view_customer.dart'; // Add this import
...
class _CustomersPageState extends State<CustomersPage> {
  ...
  bool isPermissionsLoaded = false; // Add this flag
  int customerTotal = 0;
    ...
    try {
      ...
      if (permissionResponse.permissionDetails.isNotEmpty) {
        setState(() {
          ...
          isPermissionsLoaded = true; // Set the flag
        });
      } else {
        setState(() {
          isPermissionsLoaded = true; // Set the flag even if no permissions
        });
        _showError('No permissions data available.');
      }
    } catch (e) {
      setState(() {
        isPermissionsLoaded = true; // Set the flag even on error
      });
  ...
  void _editCustomer(Customers customer) async {
    ...
    Map<String, dynamic> customerData = {
      ...
      'cust': customer.custId, // Add this for the API call
    };
