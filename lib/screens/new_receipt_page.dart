...
class NewReceiptPage extends StatefulWidget {
  final Map<String, dynamic>? editData; // For editing existing receipt
...
class _NewReceiptPageState extends State<NewReceiptPage> {
  ...
  int _selectedIndex = 2; // Set index to 2 for "Receipts"
  ...
  Map<String, String> walletNameMap = {}; // Added for reverse lookup
